...
const Table = () => {
  ...
  useEffect(() => {
    isProvider ? setTableData(providerBookings) : setTableData(clientBookings);
  ...
  return (
    <>
      <div className='container mx-auto'>
        ...
        <div className='flex items-center justify-start md:justify-between w-full mb-3 relative'>
          <div className='w-40 sm:w-50 md:70'>
            <span className='text-4xl md:text-4xl uppercase font-bold text-gray-800 mr-1'>
              {monthNames[month]}
            </span>
            <span className='text-4xl md:text-4xl font-bold text-gray-800'>{year}</span>
          </div>
                            ...
                            <tr key={el._id} className='bg-white border-b w-20'>
                              ...
                              <td className='text-sm text-black px-2 py-2'>
                                <a href={`/user/meetingDetails/${el._id}`}>
                                  ...
                                  >
                                    <PencilAltIcon className='h-6 w-6 inline-flex leading-none' />
                                  </button>
                                </a>
                              </td>
                              <td className='text-sm text-black px-2 py-2'>
                                {el.answeredQuestions.length > 0 ? (
                                  <Link href={`/user/meetingDetails/${el._id}/questions`} passHref>
                                    <button
                                      type='button'
                                      className='bg-gray-200 hover:bg-gray-500 text-black hover:text-white font-bold py-2 px-4 rounded-md'
                                    >
                                      <QuestionMarkCircleIcon className='h-6 w-6 inline-flex leading-none' />
                                    </button>
                                  </Link>
                                ) : (
                                  <button
