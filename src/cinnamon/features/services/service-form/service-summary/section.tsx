...
export function MiniSection({title, content}) {
  return (
    <div className='flex border-b border-gray-200 pb-3 mb-3 last:border-b-0 last:mb-0'>
      <span className='w-1/4 text-sm text-gray-700 font-bold'>{title}</span>
    ...
    <div className='flex flex-col'>
      ...
      <div className='flex flex-col'>
        {day.hours.map((hour, index) => (
          <div className='flex space-x-3 mt-2' key={index}>
