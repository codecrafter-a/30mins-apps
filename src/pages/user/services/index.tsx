...
export default function Services() {
  ...
  const addOrgServicePress = () => {
    if (!hasOrgs || !hasOrgServiceCats || !hasOrgExtention || !hasCalendar) {
      setDialogOpen(true);
    } else {
      setLoadingOrg(true);
      router.push('/user/services/service-form/?mode=create&stype=organization');
    }
  };
  ...
  return (
    <PostLoginLayout>
      ...
      <>
        <ActionBar
          addOrgServicePress={addOrgServicePress}
          LoadingOrg={LoadingOrg}
          addServicePress={addServicePress}
          toggleWorkingHours={toggleWorkingHours}
        />
        {!serviceData && (
          <Error
