            ...
            <div className='w-full flex justify-between h-16 gap-2'>
              ...
              {session ? (
                <div className='hidden sm:ml-2 sm:flex gap-2 sm:items-center'>
                  <Link href={`/${lang}/user/profile`} passHref>
                ...
                <div className='hidden sm:flex felx-col gap-2 justify-center items-center '>
                  <Link href={`/${router.locale}/auth/login`} passHref className='h-max'>
                    <Button type='button' className='h-max' variant='outline' onClick={() => {}}>
                      {t('common:LOGIN')}
                    </Button>
                  </Link>
                  <Link href={`/${router.locale}/auth/signup`} passHref className='h-max'>
                    <Button type='button' className='h-max' variant='solid' onClick={() => {}}>
                      {t('common:SIGN_UP')}
                    </Button>
                  </Link>
                </div>
