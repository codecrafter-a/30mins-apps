...
import {ChevronDownIcon, DotsHorizontalIcon, DuplicateIcon} from '@heroicons/react/outline';
...
const TableRow = ({service, refetch}) => {
  ...
  return (
    <Row styles='text-sm'>
        ...
        <div className='flex flex-col'>
          <div>
            ...
            <div className='flex items-center space-x-2 mt-1'>
              ...
              >
                <DuplicateIcon className='w-5 h-5 text-mainBlue flex-shrink-0' />
              </button>
      ...
      <Cell styles='text-sm hidden lg:table-cell'>{t(service.serviceType)}</Cell>
