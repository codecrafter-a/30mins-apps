import {GiftIcon, GlobeIcon, ReceiptTaxIcon} from '@heroicons/react/outline';
    ...
    <>
      ...
      {serviceDonate === 'yes' && (
        <>
          ...
          />
          <div className='flex flex-col mb-16 w-full lg:w-1/2'>
          ...
          <StepHeader
            ...
            icon={<ReceiptTaxIcon className='w-6 h-6' />}
          />
