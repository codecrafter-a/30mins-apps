    ...
    <Modal title={t('common:start_conversation')} medium>
              ...
              <div className='flex flex-row gap-4'>
                <div className='sm:flex flex-col w-full gap-0'>
                  ...
                  <input
                    ...
                    className='mt-1 block border h-12 border-gray-300 rounded-md shadow-sm 
                          mr-3 focus:outline-none focus:ring-mainBlue w-full'
                  />
                </div>

                <Button
                  className='w-4/12 h-12 self-end flex
      ...
      <div className='py-3 sm:px-6 flex flex-row-reverse flex-wrap sm:flex-nowrap gap-2'>
        ...
        <button
          ...
          className='bg-mainBlue  shadow-md mr-2 rounded-md py-2 px-4 
                    inline-flex justify-center text-sm font-medium text-white 
                    focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-mainBlue
                    disabled:bg-slate-500 disabled:opacity-30'
        >
