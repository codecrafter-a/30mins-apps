...
export default function ServiceMedia({setErrors, serviceImage, handleChange}: IProps) {
  //
  ...
  return (
    <>
      <StepHeader
        question={t('service_image_question')}
        description={t('service_image_description')}
