...
import {ArchiveIcon, DotsVerticalIcon} from '@heroicons/react/solid';
import {BanIcon, InboxIcon} from '@heroicons/react/outline';
        ...
        <Menu defaultValue={0} as='div' className='relative z-10 inline-block text-left'>
          <div>
            ...
            >
              ...
              {options.archive[0] && <ArchiveIcon className='text-purple-400 w-7' />}
              {options.blocked[0] && <BanIcon className='text-red-400 w-7' />}
              <div className='relative w-max'>
                <DotsVerticalIcon width={22} height={22} className='text-black' />
                <span
            ...
            <Menu.Items className='absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none'>
              <div className='px-1 py-1'>
                ...
                <Menu.Item>
                  ...
                  >
                    <div className='relative w-max'>
                      <BanIcon className='mr-2 h-6 w-6' />
