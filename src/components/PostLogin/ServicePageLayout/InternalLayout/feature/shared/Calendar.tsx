...
const Calendar = ({
  ...
  const selectFisrtDay = _workingWeekDays => {
    ...
    const currentIndex = dayjs() // 2
      .tz(selectedBookerTimezone)
      .month(selectedMonth)
      .date(currentDay)
      .day();
    let index = 0;
    let fisrtDayInweek: any = _workingWeekDays[index]; // 4
    let stopLoop = true;
    ...
    <>
      ...
      >
        <div className='max-w-xs mb-4'>
          ...
          <div className='grid grid-cols-4  text-xs sm:grid-cols-4'>
            <div className='col-span-1 py-3 text-xs font-light'>Timezone:</div>
            <div className='col-span-3 text-xs font-light'>
              <select
                ...
                className='mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 text-xs'
              >
                {TimezonesPicker}
              </select>
            </div>
