import {CheckIcon, ChevronLeftIcon, ClipboardListIcon} from '@heroicons/react/outline';
...
export default function ServiceSummary({
  ...
  return (
    <>
      <StepHeader
        question='Here is an overview summary of your service'
        description='Review your service before submitting, select a step or click Go Back to correct some information.'
        ...
        content={
          <div>
            ...
            <MiniSection
              ...
              content={
                <a
                  href={`https://30mins.com/${values.serviceSlug}`}
                >{`https://30mins.com/${values.serviceSlug}`}</a>
              }
            />
              ...
              content={
                <>
                  {values.serviceQuestionsList.map((question, index) => (
                    <div
                      className='flex flex-col p-6 bg-gray-100 mb-4 last:mb-0 bg-opacity-50'
                      key={index}
                    >
                      <MiniSection title={t('question')} content={question.question} />
                      <MiniSection title={t('question_type')} content={t(question.questionType)} />
                      <MiniSection
                        title={t('required')}
