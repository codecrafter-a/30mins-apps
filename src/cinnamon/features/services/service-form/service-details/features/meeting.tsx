  ...
  return (
    <>
      <div className={classNames(['grid grid-cols-4 gap-4'])}>
        ...
        <div
          className={classNames([
            'col-span-2 md:col-span-2 xl:col-span-1 flex flex-col',
            'justify-end',
          ])}
        >
          <Field
          ...
          >
            <div className='flex flex-grow'>
              ...
              <div className='flex flex-col border border-l-0 border-gray-300 w-11 justify-between items-center'>
                <button
                  onClick={() =>
                    meetingDuration + 5 < 300 && setValue('meetingDuration', meetingDuration + 5)
                  }
                ...
                <button
                  onClick={() =>
                    meetingDuration >= 5 && setValue('meetingDuration', meetingDuration - 5)
                  }
        ...
        >
          ...
          >
            <div className='flex flex-row justify-center w-full border border-gray-300 rounded-lg'>
              <CheckBox
                key={1}
                code={'Yes'}
                label={'Yes'}
              ...
              />
              <div className=' border-gray-300 rounded-r-lg flex-grow justify-start px-4 items-center flex bg-gray-200 bg-opacity-60'>
                {t('common:txt_weekly')}
              </div>
            </div>
          </Field>
        ...
        <div className='col-span-4 md:col-span-2 flex w-full '>
          ...
          >
            <div className='flex flex-wrap justify-evenly w-full border border-gray-300 rounded-lg'>
