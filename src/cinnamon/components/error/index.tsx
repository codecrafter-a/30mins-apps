...
export default function Error({image, title, description}) {
  return (
    <div className='flex flex-col items-center justify-center py-24 px-6 border border-gray-200 mt-6 rounded-lg shadow-md'>
      ...
      <h2 className='text-mainText my-2 text-lg font-medium'>{title}</h2>
  ...
  return (
    <div className='flex flex-col items-center justify-center py-24 px-6 border border-gray-200 mt-6 rounded-lg shadow-md'>
      ...
      <div className='flex flex-col gap-2'>
        <Button
          onClick={() => (router.push('/user/extensions'), hideModal && hideModal())}
          variant='solid'
        >
          {t('go_to_extentions')}
        </Button>
