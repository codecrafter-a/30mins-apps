...
export function FieldError({
  ...
  return (
    <div
      className={classNames(
        'bg-red-50 flex space-x-2 px-2 text-sm text-red-500 mb-19px font-medium items-center border-red-200 ',
        position === 'top' && 'rounded-t-md border border-b-0 ',
        position === 'center' && 'rounded-b-md border rounded-t-md mt-2 ',
        position === 'bottom' && 'rounded-b-md border border-t-0 w-full mx-0 ',
        className
      )}
    >
      <ExclamationCircleIcon className='w-5 h-5 mt-0.5' />
