...
export default function StepHeader({
  ...
  return (
    <div className={classNames('flex flex-col md:flex-row justify-between gap-4 mb-6', className)}>
              ...
              <>
                ...
                {mode === 'create' || (mode === 'edit' && step <= 2) ? (
                  <Button
                    ...
                    onClick={() =>
                      stepName === 'ServicePayment' ? move('preview', false) : move('next', false)
                    }
                  >
                    {stepName === 'ServicePayment' ? t('preview') : t('continue')}
                    {stepName !== 'ServicePayment' && (
                  ...
                  >
                    {editServiceLoading || editOrgServiceLoading ? (
